...
resource "azurerm_dns_cname_record" "api_cname" {
  ...
  # record = data.azurerm_function_app.hots_db_functions_reference.default_hostname
...
resource "azurerm_dns_txt_record" "api_txt" {
  ...
  record {
    ...
    value = data.azurerm_function_app.hots_db_functions_reference.custom_domain_verification_id
  }
}
